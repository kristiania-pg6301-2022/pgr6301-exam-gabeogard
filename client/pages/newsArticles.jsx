...
export function NewsArticles({user}) {
    ...
    const categorySet = []
    data?.map((article) => (
        categorySet.push(article.category)
    ))
                    ...
                    <div className={"filter-section"}>
                        <div className={"category_select"} >
                            ...
                            <p className={"category_name"}
                               onClick={() => setDataSet(data)}>All</p>
                        {finalCategories.map((category) => (
                            <p className={"category_name"}
                            onClick={() => setDataSet(pickCategory(category, data))}>{category}</p>
                        ))
                        };
                        </div>
                    </div>
        ...
        return (
            <div>
                ...
                <div className={"grid-container"}>
                    ...
                    <div className={"news-section"}>
                        {dataSet?.map((article) => (
                            <ReadOnlyArticle title={article.title}
                                     category={article.category}
                                     content={article.content}
                                     auth={article.author}/>
                        ))}
